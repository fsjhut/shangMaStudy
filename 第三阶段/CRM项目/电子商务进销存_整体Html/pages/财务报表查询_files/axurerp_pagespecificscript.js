...
var PageName = '财务报表查询';
var PageId = 'p297af0778d50491baff861c138a7e2f6'
var PageUrl = '财务报表查询.html'
document.title = '财务报表查询';
...
if (true) {
	...
	self.location.href="实际库存商品分产品损益情况查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="进销存情况的管理报表查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="财务收支情况表查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="应交税费查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="资产负债表查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="应付职工薪酬查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="出入库流水账查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="损益表查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="现金流量表查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="采购产品分析表查询.html" + GetQuerystring();
