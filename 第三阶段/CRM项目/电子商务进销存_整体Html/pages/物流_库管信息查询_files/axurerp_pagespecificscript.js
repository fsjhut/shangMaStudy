...
var PageName = '物流/库管信息查询';
var PageId = 'p81a582d5a201446f9e3682a7f857b918'
var PageUrl = '物流_库管信息查询.html'
document.title = '物流/库管信息查询';
...
if (true) {
	...
	self.location.href="收发存汇总表查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="借机统计表查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="物流_库管信息.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="物流分析查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="库存统计表查询.html" + GetQuerystring();
