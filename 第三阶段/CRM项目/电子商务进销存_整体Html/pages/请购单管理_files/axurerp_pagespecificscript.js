...
var PageName = '请购单管理';
var PageId = 'pbcac588daef94845ab39fe66fdb6fd61'
var PageUrl = '请购单管理.html'
document.title = '请购单管理';
...
if (true) {
	...
	self.location.href="请购单添加.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="请购单审核跟踪信息.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="请购单审核不通过修改.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="请购单查看.html" + GetQuerystring();
