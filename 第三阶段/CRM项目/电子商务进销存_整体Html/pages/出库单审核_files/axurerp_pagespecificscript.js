...
var PageName = '出库单审核';
var PageId = 'pb0335b59facc4f14aaa61bd10b06a974'
var PageUrl = '出库单审核.html'
document.title = '出库单审核';
...
eval(GetDynamicPanelScript('u378', 3));
...
if (true) {
	...
	self.location.href="02出库单审核跟踪.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="01出库单审核页面.html" + GetQuerystring();
...
u823.style.cursor = 'pointer';
if (bIE) u823.attachEvent("onclick", Clicku823);
else u823.addEventListener("click", Clicku823, true);
function Clicku823(e)
{
