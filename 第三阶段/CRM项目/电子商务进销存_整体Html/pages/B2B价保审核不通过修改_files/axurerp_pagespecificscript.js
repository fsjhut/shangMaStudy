...
var PageName = 'B2B价保审核不通过修改';
var PageId = 'pe2691c51b83343789271cff700ee4213'
var PageUrl = 'B2B价保审核不通过修改.html'
document.title = 'B2B价保审核不通过修改';
...
if (true) {
	...
	self.location.href="B2B价保商品修改.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="B2B价保商品添加_1.html" + GetQuerystring();
