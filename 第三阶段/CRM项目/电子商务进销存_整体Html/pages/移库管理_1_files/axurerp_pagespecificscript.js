...
var PageName = '移库管理';
var PageId = 'pc95f31bbdfb0426b8a9d7ecdefb4eeab'
var PageUrl = '移库管理_1.html'
document.title = '移库管理';
...
if (true) {
	...
	self.location.href="03移库单退回待移库.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="01移库单待移库移库.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="02移库单移库完毕查看.html" + GetQuerystring();
