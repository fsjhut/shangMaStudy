...
var PageName = '合同类别修改';
var PageId = 'p175b8a108d2d45f1b8caa474b54de9bb'
var PageUrl = '合同类别修改.html'
document.title = '合同类别修改';
...
if (true) {
	...
	self.location.href="合同类别管理.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="合同类别详情.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="合同类别添加.html" + GetQuerystring();
