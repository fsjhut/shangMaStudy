...
var PageName = '入库管理';
var PageId = 'pb8654a335254471bb9aaabd4ba45c39a'
var PageUrl = '入库管理_1.html'
document.title = '入库管理';
...
if (true) {
	...
	self.location.href="04采购入库单入库完毕查看页面.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="采购订单详细信息.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="入库单添加信息.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="入库单详细信息.html" + GetQuerystring();
