...
var PageName = '计算公式编辑';
var PageId = 'pb66a0d164e7543d5b85243115ced348f'
var PageUrl = '计算公式编辑_1.html'
document.title = '计算公式编辑';
...
if (true) {
	...
	self.location.href="币别管理.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="凭证字管理.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="模板修改.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="凭证模板管理.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="辅助核算项目管理.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="基础资料同步.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="关联交易分类管理.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="模板详情.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="总账参数设定.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="现金流量项目管理.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="会计科目管理.html" + GetQuerystring();
