...
var PageName = '订单退款审核';
var PageId = 'pc700cc74815d4d92a8ff45eff6abdbd1'
var PageUrl = '订单退款审核.html'
document.title = '订单退款审核';
...
eval(GetDynamicPanelScript('u415', 3));
...
if (true) {
	...
	self.location.href="02订单退款审核跟踪.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="01订单退款审核页面.html" + GetQuerystring();
