...
var PageName = '发货记录导入';
var PageId = 'p0a2caac7057c4efa9ab7cb5eed19db98'
var PageUrl = '发货记录导入.html'
document.title = '发货记录导入';
...
if (true) {
	...
	self.location.href="发货状态修改.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="发货状态批量修改.html" + GetQuerystring();
