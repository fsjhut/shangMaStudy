...
var PageName = '调拨要货详细信息';
var PageId = 'p81e46871364742e2b4cada4e99f792ec'
var PageUrl = '调拨要货详细信息.html'
document.title = '调拨要货详细信息';
...
if (true) {
	...
	self.location.href="采购退货计划单审核管理.html" + GetQuerystring();
...
u918.style.cursor = 'pointer';
if (bIE) u918.attachEvent("onclick", Clicku918);
else u918.addEventListener("click", Clicku918, true);
function Clicku918(e)
{
...
if (true) {
	...
	self.location.href="调拨要货单查看.html" + GetQuerystring();
