...
var PageName = '入库核算清单查询';
var PageId = 'p19778e42ead245cc9571d065beaf96f6'
var PageUrl = '入库核算清单查询.html'
document.title = '入库核算清单查询';
...
if (true) {
	...
	self.location.href="成本结算.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="入库核算凭证查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="凭证生成.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="商品入库核算.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="入库核算清单修改.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="存货跌价准备维护.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="入库核算清单详情.html" + GetQuerystring();
