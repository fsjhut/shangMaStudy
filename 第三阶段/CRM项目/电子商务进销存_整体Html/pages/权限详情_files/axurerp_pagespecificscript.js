...
var PageName = '权限详情';
var PageId = 'pe6452111d2cc4464bab9e4fd3cbe5c5d'
var PageUrl = '权限详情.html'
document.title = '权限详情';
...
if (true) {
	...
	self.location.href="权限添加.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="角色详情.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="权限修改.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="权限报表.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="审批流程管理.html" + GetQuerystring();
