...
var PageName = 'B2B返利管理';
var PageId = 'p99ae0030d156426f9aaa801a746e8e17'
var PageUrl = 'B2B返利管理.html'
document.title = 'B2B返利管理';
...
if (true) {
	...
	self.location.href="B2B返利审核信息.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="B2B返利查看.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="B2B返利修改.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="B2B返利添加.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="B2B返利审核不通过修改.html" + GetQuerystring();
