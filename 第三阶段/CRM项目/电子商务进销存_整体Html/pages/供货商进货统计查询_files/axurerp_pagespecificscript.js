...
var PageName = '供货商进货统计查询';
var PageId = 'pb997b118f9e04a11b3c48be3601aad06'
var PageUrl = '供货商进货统计查询.html'
document.title = '供货商进货统计查询';
...
if (true) {
	...
	self.location.href="消耗汇总查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="商品进货统计查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="退货统计查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="供货商进货统计.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="结算数据统计查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="供货商对账查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="采购情况表查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="进货价格差异表查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="台账查询.html" + GetQuerystring();
