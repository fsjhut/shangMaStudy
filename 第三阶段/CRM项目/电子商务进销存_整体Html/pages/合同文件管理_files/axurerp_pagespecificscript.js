...
var PageName = '合同文件管理';
var PageId = 'p64f39ba5a90f4d9483bbaa0b9779d9e5'
var PageUrl = '合同文件管理.html'
document.title = '合同文件管理';
...
if (true) {
	...
	self.location.href="合同文件详情.html" + "";
...
if (true) {
	...
	self.location.href="合同文件修改.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="合同文件添加.html" + GetQuerystring();
