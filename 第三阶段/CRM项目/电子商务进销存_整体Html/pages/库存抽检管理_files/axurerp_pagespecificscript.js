...
var PageName = '库存抽检管理';
var PageId = 'pe2e754be163840d88e527b7091b61387'
var PageUrl = '库存抽检管理.html'
document.title = '库存抽检管理';
...
if (true) {
	...
	self.location.href="库存抽查详细信息.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="库存抽查单添加.html" + GetQuerystring();
