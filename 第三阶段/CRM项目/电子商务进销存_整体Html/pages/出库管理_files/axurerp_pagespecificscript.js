...
var PageName = '出库管理';
var PageId = 'p5b7f2eede7d045929aed9379d0e6678d'
var PageUrl = '出库管理.html'
document.title = '出库管理';
...
if (true) {
	...
	self.location.href="01采购退货订单待出库查看页面.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="02采购退货订单已出库查看页面.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="03采购出库单出库页面.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="05采购出库单退回待出库页面.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="04采购出库单录入完毕页面.html" + GetQuerystring();
