...
var PageName = 'B2B订单管理';
var PageId = 'p2f570686d86c4ba893f2e190437d8a35'
var PageUrl = 'B2B订单管理.html'
document.title = 'B2B订单管理';
...
if (true) {
	...
	self.location.href="B2B订单状态修改.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="B2B订单详细信息.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="B2B审核跟踪信息.html" + GetQuerystring();
