...
var PageName = 'B2B更换货管理';
var PageId = 'pc7c7f57d5ba542b482c114b7200886f4'
var PageUrl = 'B2B更换货管理.html'
document.title = 'B2B更换货管理';
...
if (true) {
	...
	self.location.href="01.详情_11.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="05.审核跟踪_7.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="03.修改_3.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="02.添加_3.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="04.审核不通过修改_8.html" + GetQuerystring();
