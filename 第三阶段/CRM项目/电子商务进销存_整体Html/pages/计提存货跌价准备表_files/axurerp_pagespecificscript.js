...
var PageName = '计提存货跌价准备表';
var PageId = 'pdbafaffbb406421caeac26c500c09d15'
var PageUrl = '计提存货跌价准备表.html'
document.title = '计提存货跌价准备表';
...
if (true) {
	...
	self.location.href="计提存货跌价准备计算清单修改.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="计提存货跌价准备计算清单详情.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="计提存货跌价准备凭证查询.html" + GetQuerystring();
