...
var PageName = '采购管理';
var PageId = 'p8fd6226996704cdd9fd972a735a6f860'
var PageUrl = '采购管理_1.html'
document.title = '采购管理';
...
if (true) {
	...
	self.location.href="采购订单查看.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="采购订单审核跟踪.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="采购订单修改.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="采购订单审核不通过修改.html" + GetQuerystring();
