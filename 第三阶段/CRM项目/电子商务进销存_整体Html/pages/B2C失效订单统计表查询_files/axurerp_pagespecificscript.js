...
var PageName = 'B2C失效订单统计表查询';
var PageId = 'pd53a03d2b86c4da0819e60c64386a815'
var PageUrl = 'B2C失效订单统计表查询.html'
document.title = 'B2C失效订单统计表查询';
...
if (true) {
	...
	self.location.href="B2C失效订单统计表.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="B2C销量销售额统计表查询.html" + GetQuerystring();
