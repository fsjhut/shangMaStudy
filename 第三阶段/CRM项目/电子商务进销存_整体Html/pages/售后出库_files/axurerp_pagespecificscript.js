...
var PageName = '售后出库';
var PageId = 'pc102522108aa41dea1bab8f817de23ae'
var PageUrl = '售后出库.html'
document.title = '售后出库';
...
if (true) {
	...
	self.location.href="08售后出库单出库完毕页面-换货.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="09售后出库单出库退回待出库-返厂.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="04售后出库订单已出库查看-换货.html" + GetQuerystring();
...
u938.style.cursor = 'pointer';
if (bIE) u938.attachEvent("onclick", Clicku938);
else u938.addEventListener("click", Clicku938, true);
function Clicku938(e)
{
...
if (true) {
	...
	self.location.href="06售后出库单出库页面-换货.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="01售后出库订单待出库查看-返厂.html" + GetQuerystring();
...
if (bIE) u909.attachEvent("onclick", Clicku909);
else u909.addEventListener("click", Clicku909, true);
function Clicku909(e)
{
...
if (true) {
	...
	self.location.href="10售后出库单出库退回待出库-换货.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="05售后出库单出库页面-返厂.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="02售后出库订单待出库查看-换货.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="07售后出库单出库完毕页面-返厂.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="03售后出库订单已出库查看-返厂.html" + GetQuerystring();
...
if (bIE) u1011.attachEvent("onclick", Clicku1011);
else u1011.addEventListener("click", Clicku1011, true);
function Clicku1011(e)
{
...
if (bIE) u915.attachEvent("onclick", Clicku915);
else u915.addEventListener("click", Clicku915, true);
function Clicku915(e)
{
...
if (bIE) u927.attachEvent("onclick", Clicku927);
else u927.addEventListener("click", Clicku927, true);
function Clicku927(e)
{
