...
var PageName = '入库单审核';
var PageId = 'pac26f7c620ae481da24ad3e6c64dddd8'
var PageUrl = '入库单审核_1.html'
...
eval(GetDynamicPanelScript('u364', 3));
...
if (true) {
	...
	self.location.href="入库审核跟踪信息.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="入库审核页面.html" + GetQuerystring();
