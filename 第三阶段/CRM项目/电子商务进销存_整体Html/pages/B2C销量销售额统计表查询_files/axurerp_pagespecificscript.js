...
var PageName = 'B2C销量销售额统计表查询';
var PageId = 'pf1b57e5258d84b86bb8ad24ce5126416'
var PageUrl = 'B2C销量销售额统计表查询.html'
document.title = 'B2C销量销售额统计表查询';
...
if (true) {
	...
	self.location.href="销售情况表查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="B2C销售报表查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="B2B客户活跃度报表查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="B2C销量销售额统计表.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="B2C失效订单统计表查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="月度产品进销存报表查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="B2C月度销售报表查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="天翼工坊销售报表查询.html" + GetQuerystring();
...
if (true) {
	...
	self.location.href="个性化业务实体渠道销售报表查询.html" + GetQuerystring();
