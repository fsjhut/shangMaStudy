...
public interface BaseDao <T>{
    /**
     * @Title: getAllProduct
     * @Description: 分页查询设计的抽象
     * @param: [page, pageSize, queryProd]
     * @return: java.util.List<T>
     * @date: 2021/5/18 22:50
     * @version: 1.0
     */
    List<T> getObj(Integer page, Integer pageSize,  T t) throws Exception;
    Integer getObjNum(T t) throws Exception;
    /**
