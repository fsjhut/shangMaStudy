    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(user!=null){
            ...
            writer.print("<link rel=\"stylesheet\" type=\"text/css\" href=\""
                    +req.getContextPath()+"/css/bootstrap.css\"/>");
            writer.print("</head>");
            writer.print("<body>");
            writer.print("欢迎你 "+user.getName());
           writer.print("<hr/>");
           writer.print("<table class='table'>");
            ...
            for(MyUser mu : allUser){
                writer.print("<tr>");
                writer.print("<td>");
                writer.print(mu.getId());
                writer.print("</td>");
                writer.print("<td>");
                writer.print(mu.getName());
                writer.print("</td>");
                writer.print("<td>");
                writer.print(mu.getPhone());
                writer.print("</td>");
                writer.print("<td>");
                writer.print(mu.getResume());
                writer.print("</td>");
                writer.print("</tr>");
            }
