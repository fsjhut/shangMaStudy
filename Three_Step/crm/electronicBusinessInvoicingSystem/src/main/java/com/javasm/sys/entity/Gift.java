...
public class Gift extends BaseEntity implements Serializable {
    ...
    public String toString() {
        return "Gift{" + "giftId=" + giftId + ", giftName='" + giftName + '\'' + ", giftType='" + giftType + '\'' + ", giftModel='" + giftModel + '\'' + ", giftPrice=" + giftPrice + ", giftCost=" + giftCost + ", giftDepartment='" + giftDepartment + '\'' + ", giftInventory=" + giftInventory + ", giftColor='" + giftColor + '\'' + ", giftBrand='" + giftBrand + '\'' + ", giftNumber=" + giftNumber + ", giftTyprice=" + giftTyprice + ", giftReviewstatus=" + giftReviewstatus + '}';
    }
