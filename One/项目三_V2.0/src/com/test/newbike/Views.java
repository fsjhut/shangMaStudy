...
class Views {
    ...
    static void userView() {
        ...
        System.out.println("             1.借    出           ");
        System.out.println("             2.归    还           ");
    ...
    public static void companyView() {
        System.out.println("******************************************************");
        System.out.println("| 公司ID  |  公司名称 | 公司单车数量 | 公司单车借出次数| ");
        System.out.println("******************************************************");
    }

    public static void bikeView() {
        System.out.println("----------------------------------------------------------");
        System.out.println("| 序号 | 单车ID  | 单车名字 | 单车状态 | 借出时间 | 借出次数 |");
        System.out.println("----------------------------------------------------------");

    }

    public static void bikeRankView() {
        System.out.println("*******************************");
